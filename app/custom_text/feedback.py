...
async def generate_feedback(text: str, translation: str, learning_mode: str = "GENERAL") -> str:
    prompt = _PROMPT_TEMPLATE.format(text=text, translation=translation, tone_note=tone_note(learning_mode))
