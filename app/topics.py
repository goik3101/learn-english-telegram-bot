"""오늘의 주제 기반 통합 학습: 단어/해석(Reading)이 서로 무관하게 각자 어휘를 뽑다 보니 해석
지문이 사용자 수준과 동떨어진 학술 어휘로 생성되는 문제(사용자 피드백)를 막기 위해, 하루 단위로
"오늘의 주제"를 하나 정해서 두 영역이 그 주제의 핵심 단어 풀을 공유하게 한다.

(예전에는 회화도 이 풀을 함께 공유했으나, 2026-09에 회화 기능 자체가 제거되었다.)
